...
@Inject
class AndroidBeeperClient(private val context: Context) : BeeperClient {
    override suspend fun getChats(): Either<String, List<BeeperChat>> = withContext(Dispatchers.IO) {
        try {
    ...
    override suspend fun sendMessage(roomId: String, text: String): Either<String, Unit> = withContext(Dispatchers.IO) {
        try {
