...
class GatekeeperReducerTest {
    ...
    fun `SurgicalNavigationRequested blocks YouTube watch and shorts`() {
        ...
        assertThat(watchState.media.activeYouTubeUrl).isEqualTo("gatekeeper://safe_channels") // Unchanged
        ...
        assertThat(shortsState.media.activeYouTubeUrl).isEqualTo("gatekeeper://safe_channels") // Unchanged
    }
    ...
    fun `SurgicalNavigationRequested jails YouTube homepage to subscriptions`() {
        ...
        val newState = reduce(state, action).state
        assertThat(newState.media.activeYouTubeUrl).isEqualTo("gatekeeper://safe_channels")
    }
