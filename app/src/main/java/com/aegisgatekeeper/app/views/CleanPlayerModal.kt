...
@Composable
actual @SuppressLint("SetJavaScriptEnabled")
@Suppress("FunctionName")
@Composable
                ...
                override fun onReceive(
                    ...
                    when (intent?.action) {
                        ...
                        "com.aegisgatekeeper.app.WEB_STOP" -> {
                            ...
                            GatekeeperStateManager.dispatch(
                                GatekeeperAction.TriggerMetacognition("CleanPlayer: YouTube", duration)
                            )
                            onStop()
                        }
                    }
                                ...
                                WebAppInterface(
                                    ...
                                    onStateChangeCallback = { state ->
                                        ...
                                        if (state == 0) { // ENDED
                                            currentPosition = 0f
                                            GatekeeperStateManager.dispatch(
                                                GatekeeperAction.SaveMediaPosition(videoId, 0f)
                                            )
