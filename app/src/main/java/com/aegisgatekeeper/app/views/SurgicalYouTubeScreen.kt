    ...
    Column(
        ...
        BaseSurgicalWebView(
            ...
            jsInjector = { currentUrl ->
                ...
                """
                (function() {
                    console.log('GK_DEBUG: Surgical Script Initializing...');
                    $initSafeChannels
                    ...
                    function applyFilters() {
                        ...
                        // 1. NEUTRALIZE LINKS: Point watch/shorts links to nowhere.
                        // This allows native scroll momentum to work perfectly.
                        document.querySelectorAll('a[href*="/watch?v="], a[href*="/shorts/"], a#logo, a[href="/"], a[href^="/?"]').forEach(function(link) {
                            ...
                            link.onclick = function(e) {
                                ...
                                if (typeof AndroidBridge !== 'undefined') {
                                    AndroidBridge.logMessage('🛡️ Blocked direct navigation. Use the +BANK button.');
                                }
                                return false;
                            };
                        });

                        // 2. COSMETIC NUKE: Hide the logo, navigation bars, and shorts shelves.
                        const selectors = [
                            ...
                            'a#logo',                       // Top Left Logo
                            'ytm-masthead-logo-renderer',   // Modern Header Logo container
                            'ytm-search-box .header-back-button' // Back button that breaks jail
                        ];
                        
                        function nuke(root) {
                            selectors.forEach(s => root.querySelectorAll(s).forEach(el => el.style.setProperty('display', 'none', 'important')));
                        ...
                        // 5. PROCESS SEARCH/CHANNEL RESULTS (+BANK with duration fix)
