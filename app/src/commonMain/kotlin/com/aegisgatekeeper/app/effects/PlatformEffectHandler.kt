...
interface PlatformEffectHandler {
    ...
    fun scheduleBeeperMessage(message: ScheduledMessage, delayMillis: Long)
    ...
    suspend fun fetchUrlMetadata(url: String, isSoundCloud: Boolean = false, isGeneric: Boolean = false): Either<String, ContentMetadata>
