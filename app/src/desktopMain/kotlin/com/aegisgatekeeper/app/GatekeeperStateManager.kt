        ...
        when (action) {
            ...
            is GatekeeperAction.CancelScheduledMessage -> {
                _state.value =
                    _state.value.copy(
                        scheduledMessages =
                            _state.value.scheduledMessages.map {
                                if (it.id ==
                                    action.id
                                ) {
                                    it.copy(status = com.aegisgatekeeper.app.domain.MessageStatus.CANCELLED)
                                } else {
                                    it
                                }
                            },
                        ...
                        scheduledMessages =
                            _state.value.scheduledMessages.map {
                                if (it.id ==
                                    ...
                                    it.copy(status = com.aegisgatekeeper.app.domain.MessageStatus.SENT)
                                } else {
                                    it
                                }
                            },
                        ...
                        scheduledMessages =
                            _state.value.scheduledMessages.map {
                                if (it.id ==
                                    ...
                                    it.copy(status = com.aegisgatekeeper.app.domain.MessageStatus.FAILED)
                                } else {
                                    it
                                }
                            },
