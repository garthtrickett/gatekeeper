    ...
    in
    {
      ...
      devShells.${system}.default = pkgs.mkShell {
        ...
        shellHook = ''
                    ...
                    alias deploy-dev='adb reverse tcp:8081 tcp:8081 &&  gradle installDevDebug && adb logcat -c && adb shell am start -n com.aegisgatekeeper.app.dev/com.aegisgatekeeper.app.MainActivity && echo "✅ DEV Deployed. Ports 8081 (Sync)  Reversed. Waiting for logs..." && logs'
                    alias deploy-prod='adb reverse tcp:8081 tcp:8081 &&  gradle installProdDebug && adb logcat -c && adb shell am start -n com.aegisgatekeeper.app/com.aegisgatekeeper.app.MainActivity && echo "✅ PROD Deployed. Ports 8081 (Sync)  Reversed. Waiting for logs..." && logs'
          ...
          echo "✅ ADB Tunnel Established (8081: Sync)"
